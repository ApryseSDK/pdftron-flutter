...
class Config {
  ...
  /// On Android, when this config is set, the user will not be able to
  /// customize each color shown. Defaults to black, blue, green for Android,
  /// and black, blue, red for iOS.
